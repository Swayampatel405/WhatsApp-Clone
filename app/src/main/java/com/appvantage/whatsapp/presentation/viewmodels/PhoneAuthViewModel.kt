package com.appvantage.whatsapp.presentation.viewmodels
...
import com.appvantage.whatsapp.MainActivity
import com.appvantage.whatsapp.model.PhoneAuthUser
...
class PhoneAuthViewModel @Inject constructor(
    ...
    fun sendVerificationCode(phoneNumber: String,activity: Activity){
        ...
        val option = object : PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            override fun onCodeSent(id: String, token: PhoneAuthProvider.ForceResendingToken) {
                ...
                Log.d("PhoneAuth","onCodeSend, verification ID:$id")
            ...
            override fun onVerificationFailed(exception: FirebaseException) {
                Log.d("PhoneAuth","Exception Occured ${exception.message}")
    ...
    fun verifyOtp(otp:String,context: Context){
        ...
        if(currentAuthState !is AuthState.CodeSent || currentAuthState.verificationId.isEmpty()){
            Log.e("PhoneAuth","Attepting a verify otp without a valid verification id")
    ...
    fun saveUserProfile(userId: String,name:String,status:String,profileImage: Bitmap){
        ...
        val userProfile = PhoneAuthUser(
            ...
            profileImage = encodedImage.toString()
        )
